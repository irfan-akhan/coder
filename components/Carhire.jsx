        ...
        return (
            <div>
                <form className={car.form}>
                    <select name="" id="" value={this.state.vehicle}  onChange={e=> this.setState({vehicle: e.target.value})}>
                        ...
                        <option value="Toyota Landcruiser 2018">Toyota Landcruiser 2018</option>
                    ...
                    <input placeholder="Pickup Address" type="text" name="" id=""   value={this.state.address} onChange={e=> this.setState({address : e.target.value})}/>
                    <input placeholder="Destination Address" type="text" name="" id=""   value={this.state.destination} onChange={e=> this.setState({ destination: e.target.value})}/>
                    <input placeholder="Date of Booking" type="date" name="" id=""  value={this.state.date} onChange={e=> this.setState({date: e.target.value})} />
                    <input placeholder="Time of Booking" type="time" name="" id=""  value={this.state.time} onChange={e=> this.setState({time: e.target.value})} />
                    <input placeholder="Number of Passengers" type="number" name="" id=""  value={this.state.days} onChange={e=> this.setState({days: e.target.value})} />
                    <button type="button" className={car.btnGrad} onClick={this.handleOpen}>
                        Proceed
                    </button>
